...
glance image-create --name "$GLANCE_NAME" --property hw_cpu_sockets=1 --property jenkins_build=$BUILD_NUMBER --property description=$ISO --property os_type=windows --disk-format raw --container-format bare --is-public true < windows-server-2012-r2.raw
